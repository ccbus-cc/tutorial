...
1、打开工具 [https://ccbus.cc/#/LPfixtool](https://ccbus.cc/#/LPfixtool)
...
不管是在CCBus平台发行的代币，还是在其他平台发行的代币，只要遭遇了池子被攻击的问题，都可以使用本修复工具解决

#### 3、修复失败怎么办

如果按照教程完成了操作步骤，依然修复失败，请加入电报群，联系客服处理 [@ccbus](https://t.me/ccbus)
