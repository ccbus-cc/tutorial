...
如果是在CCBus发行的代币，并已上传了logo，会自带这两个权限。

当然，不管你是在哪里创建发行的代币，都可以使用CCBus的权限控制工具来操作。
...
具体该怎么使用呢？首先，我们打开控制台链接：[https://help.ccbus.cc/sui/control](https://help.ccbus.cc/sui/control)  ，右上角连接钱包（这一步之大家应该很熟悉了），连接成功后右上角能看到钱包地址
...
怎么确认自己已经完成增发？可以通过钱包的数量来确认，如下图所示的对比。增发前CCBus币是100亿，增发后是101亿，这多出来的1亿就是增发来的
...
和增发一样，我们打开CCBus的代币控制页面：[https://sui.ccbus.cc/control](https://sui.ccbus.cc/control) ，首先要连接钱包（这一步就不演示了），然后点击**更新资料**按钮
...
例如我要将之前发行的CCBus代币，修改为SuiCCBus代币，如下图所示
...
* 答：是的，每次增发铸币，CCBus平台会收取1 SUI的费用。每次更新资料，会收取8 SUI的费用。

**4、使用该功能会产生哪些危害？**

* **答：**恶意使用增发权限与更新资料权限，会损害项目的长期发展。事实上，我们不建议使用该功能

如果使用权限的过程有相关问题，欢迎进群询问解答：[https://t.me/ccbus](https://t.me/ccbus)
