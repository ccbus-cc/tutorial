...
<img src="/images/Uniswap加池1.png" alt="找到资金池按钮" />

#### 2.选择V2资金池

<img src="/images/Uniswap加池2.png" alt="选择V2资金池" />

#### 3.创建资金池

在打开的V2页面中，我们可以看到自己的流动性（如果之前没有加过流动性，就显示：未找到流动性），也可以增加V2流动性或创建配对

<img src="/images/Uniswap加池3.png" alt="点击“创建配对”" />
...
<img src="/images/Uniswap加池4.png" alt="" />

<img src="/images/Uniswap加池5.png" alt="输入合约地址查找代币" />

假设我们选择ETH与FERC这个代币配对，上面输入ETH的数量，下面输入FERC的数量

<img src="/images/Uniswap加池6.png" alt="" />
...
<img src="/images/Uniswap加池7.png" alt="" />
