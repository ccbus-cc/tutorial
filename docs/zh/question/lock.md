...
<img src="/images/锁池页面.png" alt="锁池页面" />
...
<img src="/images/池子地址 (1).png" alt="" />

这个池子地址就是你的LP地址。此外，你还可以通过CCBus的控制台查看并复制池子地址，如下图所示：

<img src="/images/微信截图_20231226183607.png" alt="" />

复制之后，输入LP地址，就能看到你当前钱包的LP数量了，如下图所示：

<img src="/images/LP余额.png" alt="" />
...
<img src="/images/锁池时间.png" alt="锁池时间" />
...
<img src="/images/锁池信息1.png" alt="锁池查询" />

<img src="/images/锁池信息2.png" alt="锁池详细信息" />
