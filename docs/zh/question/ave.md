...
<img src="/images/Ave全绿.png" alt="Ave全绿效果展示" />

如何达到Ave检测全绿的效果？

### 1、标准合约自动全绿

通过CCBus创建标准合约，可以实现Ave检测自动全绿，创建地址：[https://ccbus.cc/#/coinrelease/stardand](https://ccbus.cc/#/coinrelease/stardand)
...
<img src="/images/Ave检测审计.png" alt="" />
