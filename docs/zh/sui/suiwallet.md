...
考虑到这个钱包没有中文语言翻译，大家使用起来存在一些障碍，接下来CCBus给大家大概看一下该如何使用

考虑到不同的用户是通过不同的方式注册了，那CCBus以“谷歌注册登陆”的页面给大家解读一下钱包的使用。
...
<img src="/images/18.png" alt="点击Add" />

 

<img src="/images/19.png" alt="选择创建" />

 

<img src="/images/20.png" alt="输入钱包密码" />
...
大家可以发现，我创建了一个名为CCBus 2号的钱包，当我创建出来之后，这个钱包默认就是当前钱包，它是没有资产的。
...
如果您还有其他问题，可以加入CCBus的Sui一键发币电报群了解，志愿者会给你一些解答：[https://t.me/CCBus](https://t.me/CCBus)
