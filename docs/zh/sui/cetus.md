...
<img src="/images/11-风险提示.png" alt="" />

确定交易对之后，我们选择交易费率，也就是我们通常理解的交易滑点

<img src="/images/12-选择滑点.png" alt="" />
...
<img src="/images/13-设置滑点.png" alt="" />
...
<img src="/images/16-创建交易对.png" alt="" />

之后会弹出提示，让你确认创建资金池，我们点击按钮

<img src="/images/17-确认并点击.png" alt="" />

最后会弹出钱包让你进行确认，点击Approve就可以了

<img src="/images/18-钱包确认.png" alt="" />

如果资金池创建成功了，会有下面这个提示

<img src="/images/19-资金池创建成功.png" alt="" />
...
<img src="/images/20-卖出代币.png" alt="" />

点击Swap，钱包确认后，即可完成交易

<img src="/images/21-确认交易.png" alt="确认交易" />

<img src="/images/22-钱包确认支出.png" alt="钱包确认交易" />

等待几秒钟，页面会有提示，就说明交易成功了

<img src="/images/23-交易成功.png" alt="" />
...
<img src="/images/24-我的流动性.png" alt="" />

之后我们点击最右边的小按钮，这个按钮不太好找，请注意下图位置

<img src="/images/25小按钮.png" alt="" />

然后就会进入到一个流动性操作的页面，具体内容如下图所示

<img src="/images/26-流动性操作.png" alt="" />

如果我们要增加流动性，就在增加的页面输入金额，比如这样

<img src="/images/27-增加流动性.png" alt="" />

如果要移除流动性，就在移除的页面输入数量，并确认移除比例即可

<img src="/images/28-移除流动性.png" alt="" />

其他的操作都是一样，点击按钮，钱包授权确认，即可完成操作

<img src="/images/29-钱包确认.png" alt="" />
