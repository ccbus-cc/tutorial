...
如果大家觉得Sui Wallet不好用，CCBus也推荐各位使用Suiet
...
钱包的使用是一个并不困难的过程，只是当前Suiet钱包并没有中文版本的，因此CCBus简单教大家了解一下该钱包的页面与使用方式。
...
如果您还有其他问题，可以加入CCBus一键发币电报群了解，志愿者会给你一些解答：[https://t.me/CCBus](https://t.me/CCBus)
