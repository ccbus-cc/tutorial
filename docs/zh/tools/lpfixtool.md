...
[https://youtu.be/BDyuflgYMuU](https://youtu.be/BDyuflgYMuU)
...
<img src="/images/无法加池子提示2.jpg" alt="" />
...
<img src="/images/LP修复提醒2.png" alt="" />
...
<img src="/images/LP攻击案例1.png" alt="BNB池子被攻击" />

<img src="/images/LP攻击案例2.png" alt="USDT的池子被攻击" />
...
<img src="/images/LP修复.png" alt="" />

2、选择交易所Pancake，输入**资金池地址**。其中，资金池地址可以在控制台查询，如：

<img src="/images/池子地址查询.png" alt="" />

**3、点击“查询池子”，**可以看到池子中的代币数量

<img src="/images/流动性查询.png" alt="" />
...
<img src="/images/税率白名单.png" alt="税率白名单" />
