...
* 发币之前，务必使用安装Tonkeeper钱包插件，安装教程➔ [/zh/ton/tonkeeper](/zh/ton/tonkeeper)
* 钱包内最少准备10个TON
...
首先，我们打开TON链发币链接：[https://ton.ccbus.cc/](https://ton.ccbus.cc/)，点击右上角“Connect Wallet”

<img src="/images/ton钱包连接.png" alt="连接钱包" />

在弹出来的页面选择Wallets（不要用那个扫码登陆，扫描连接的钱包无法操作发币）

<img src="/images/选择钱包.png" alt="" />

之后会弹出很多钱包让你选择，找到Tonkeeper，点击连接

<img src="/images/点击tonkeeper.png" alt="" />

此时钱包会提示让你点击确认连接

<img src="/images/钱包确认连接.png" alt="确认钱包连接" />

连接成功后，能在右上角看到你的钱包地址

<img src="/images/出现钱包地址.png" alt="" />

### 2、填写代币参数

接下来，我们按照顺序填写代币参数

<img src="/images/填写参数.png" alt="" />
...
<img src="/images/logo完成.png" alt="" />

注意，如果图片大于100k，是有提示的，如下所示，此时需要将图片改小一点

<img src="/images/错误提示 (2).png" alt="" />

如果链接输入错误，也是无法识别的，会出现下面这个情况，此时重新更换链接即可。

<img src="/images/图片识别错误.png" alt="" />

搞定了logo问题后，我重新填写了所有所有数据，大家可以看下

<img src="/images/点击创建代币.png" alt="" />

确认信息无误后，点击创建代币，弹出钱包进行确认就可以了

<img src="/images/发币钱包确认.png" alt="" />

钱包确认并支付成功后，等待几秒钟，就能看到你发行的代币页面，并通过该页面对代币进行管理

<img src="/images/代币管理页面.png" alt="" />

此时在链上浏览器里，也已经能看到你的代币资料了

<img src="/images/TONVIEWER浏览器.png" alt="Tonviewer浏览器页面，不同的浏览器显示的信息可能不一样" />
...
<img src="/images/搜索代币.png" alt="输入代币合约地址" />

<img src="/images/查找代币 (1).png" alt="" />

等待几秒钟，就能看到你的代币控制台管理页面，然后点击`编辑代币`，就能修改参数了

<img src="/images/编辑代币.png" alt="" />

在编辑页面，填写新的代币全称、代币简称以及代币简介，然后点击保存，会弹出钱包，等到确认后，就可以完成更新了

<img src="/images/编辑代币参数.png" alt="新的代币参数" />

<img src="/images/更新代币钱包确认.png" alt="钱包确认" />

除此之外，你还可以进行代币增发以及代币销毁

<img src="/images/销毁代币.png" alt="" />

<img src="/images/增发代币.png" alt="" />

当然，我们还是强烈你在代币发行完成后，丢弃权限

<img src="/images/丢弃权限.png" alt="" />
...
<img src="/images/钱包设置.png" alt="" />

在设置页面，选择代币设置

<img src="/images/选择代币.png" alt="" />

之后你会在看到钱包地址里所有的代币，如果你要它显示出来，就打勾。不想让他显示，就去除选项，就可以了

<img src="/images/显示代币.png" alt="" />

## 疑问解答

**1、错误提示503是什么意思？**

<img src="/images/网络连接错误提示.png" alt="" />

* **答：**这个提示的意思是，网络链接太卡，此时需要重新刷新网络

**2、Tonkeeper显示代币未验证怎么办？**

<img src="/images/微信截图_20240809175320.png" alt="" />
...
如有不明白或者不清楚的地方，请加入官方电报群：[https://t.me/CCBus](https://t.me/CCBus)
