...
<img src="/images/选择版本.png" alt="选择浏览器插件版本" />

钱包连接完成后，右上角会出现你的钱包地址

<img src="/images/连接成功.png" alt="" />
...
<img src="/images/增加锁.png" alt="点击Add lock" />

<img src="/images/填写锁池信息.png" alt="填写锁池信息" />
...
<img src="/images/代币列表 (1).png" alt="锁池/锁仓代币列表" />
...
<img src="/images/锁仓信息完成 (1).png" alt="" />

我填写的信息意思是这样的：我打算把手中一个叫CCBus的币锁10万个，大概锁到2024年6月29日解锁。
