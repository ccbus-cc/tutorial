...
首先，我们打开Solana批量归集的官网：[https://solana.ccbus.cc/gather](https://solana.ccbus.cc/gather) ，按照下图顺序和要求，填写并配置相关信息，同时导入要`归集`的钱包

<img src="/images/批量归集流程图.jpg" alt="" />
...
* CCBus的归集产品，除了**gas**以外，每个地址会象征性收取0.0001sol的费用，以观察归集成功率
