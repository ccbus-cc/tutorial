...
打开市值管理机器人页面：[https://solana.ccbus.cc/swapbot](https://solana.ccbus.cc/swapbot)，选择你需要操作的版本：PUMP

<img src="/images/PUMP市值管理.png" alt="" />

然后再按照如下流程操作

<img src="/images/PUMP市值管理 (1).png" alt="" />
