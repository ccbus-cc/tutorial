...
<img src="/images/ORCA查池子.png" alt="" />

然后点击Portfolio，等待几秒钟，就能看到自己的池子

<img src="/images/portfolio.png" alt="" />

<img src="/images/orca流动性.png" alt="" />

如果你想撤池子，可以点击你的交易对，选择**提取**流动性（如果想继续加池子，就选择**存入**）

<img src="/images/提取流动性.png" alt="" />

之后，按照页面需要，选择撤出的流动性比例，再点击**Withdraw，**钱包确认并支付gas即可

<img src="/images/orca撤出流动性.png" alt="" />

_注意：加了池子后，交易页面是：www.orca.co，不是www.v1.orca.co_

以上就是关于ORCA加池/撤池的相关教程了，有任何问题，记得进入官方电报群联系志愿者解答：[https://t.me/ccbus](https://t.me/ccbus)&#x20;
