...
<img src="/images/创建池 (2).png" alt="" />

打开之后，选择**标准AMM池**，然后继续下一步

* 集中池创建麻烦，且价格不能波动太大，所以一般我们推荐创建标准AMM池

<img src="/images/标准AMM池 (1).png" alt="" />

### 2、确定价格和比例

在新的页面，我们需要填写相应的代币与数量，进行流动性创建

<img src="/images/代币数量与sol数量 (2).png" alt="" />
...
<img src="/images/撤池子按钮 (1).png" alt="" />

* 注：如果你设置了开盘时间，那要等到开盘后，才能看到池子

此时，如果你想撤池子，选择那个“-”按钮就可以了，如下所示：

<img src="/images/撤池子比例 (1).png" alt="" />
...
<img src="/images/微信截图_20240528170459.png" alt="" />
...
<img src="/images/微信截图_20241001101529.png" alt="" />
