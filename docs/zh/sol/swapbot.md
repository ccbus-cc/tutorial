...
[https://youtu.be/dC4Bj3cz1z0](https://youtu.be/dC4Bj3cz1z0)
...
打开市值管理机器人页面：[https://solana.ccbus.cc/swapbot](https://solana.ccbus.cc/swapbot)，选择你需要使用的版本：**Raydium**

<img src="/images/raydium市值管理.png" alt="" />

之后我们按照如下流程进行操作

<img src="/images/市值管理.jpg" alt="" />

**1、导入钱包：**在选择的页面导入你的钱包私钥（需要几个钱包操作，就导入几个 ）

<img src="/images/导入钱包.png" alt="" />

**2、选择代币：**输入合约地址，选择你要操盘/控制的代币

<img src="/images/查询代币.png" alt="" />
